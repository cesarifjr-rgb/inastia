...
- La précision du même jour recentre cette page sur un catalogue concret de services à la carte (chef, garde d’enfants, courses, bien-être, bateau, voiture, linge, événements, etc.). Présenter les prestations avant les profils propriétaires/voyageurs, avec un devis prérempli par service, puis les modalités à la carte, pour un séjour et pour un événement. L’intendance conserve sa page ; les anciens packs internes d’heures ne sont pas l’offre commerciale de référence.
