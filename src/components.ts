...
export function header(locale: Locale, slug: string): string {
  ...
  <header class="site-header"><div class="header-inner">
    <a class="wordmark" href="${path(locale)}" aria-label="Inastia, conciergerie en Corse — ${t(locale, "accueil", "home")}">INASTIA<span class="brand-detail" aria-hidden="true">CONCIERGERIE · CORSE</span></a>
