...
export function header(locale: Locale, slug: string): string {
  ...
  const cta = audit ? t(locale, "Demander mon audit gratuit", "Request my free review") : partnership ? t(locale, "Parlons partenariat", "Let’s work together") : care ? t(locale, "Confier l’intendance de ma maison", "Arrange care for my home") : t(locale, "Parlons de votre bien", "Let’s talk about your property");
