...
export const privateFaq: Record<Locale, { question: string; answer: string }[]> = {
  fr: [
    ...
    { question: "Faut-il séjourner dans un logement géré par Inastia ?", answer: "Non. La conciergerie privée s’adresse aux voyageurs en Corse, y compris ceux qui séjournent dans un logement non géré par Inastia. La prise en charge sera étudiée selon l’adresse, les accès et, si nécessaire, l’accord de votre hôte ou du gestionnaire." },
  ...
  en: [
    ...
    { question: "Do I need to stay in a property managed by Inastia?", answer: "No. Private concierge services are for guests visiting Corsica, including those staying in accommodation not managed by Inastia. We will assess the location, access and, where necessary, your host’s or manager’s permission." },
