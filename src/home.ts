...
export function home(locale: Locale): string {
  ...
  <section class="home-hero">
    ...
    <div class="hero-main container">
      ...
      <div class="hero-actions"><a class="button" href="${contactPath(locale, "gestion")}">${t(locale, "Confier la gestion de mon bien", "Have my property managed")}${arrow}</a><a class="text-link" href="#services">${t(locale, "Comprendre les services et les frais", "Understand the services and fees")}</a></div>
