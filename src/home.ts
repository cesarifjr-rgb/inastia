...
import { contours, serviceArt, villaFallback } from "./art.ts";
...
export function home(locale: Locale): string {
  ...
  <section class="home-hero">
    ...
    <div class="hero-main container">
      ...
      <div class="hero-visual"><div class="scene-ring ring-one" aria-hidden="true"></div><div class="scene-ring ring-two" aria-hidden="true"></div><span class="scene-label-top">${t(locale, "ICI, ON PREND LE RELAIS.", "LOCAL CARE. PERSONAL ATTENTION.")}</span><div class="villa-scene" data-villa-scene data-scene-state="loading" data-scene-frame="0" aria-hidden="true">${villaFallback}</div><span class="scene-label-bottom">${t(locale, "UNE MAISON. TOUTE NOTRE ATTENTION.", "ONE HOME. OUR FULL ATTENTION.")}</span><p class="scene-caption">${t(locale, "Vue d’esprit · illustration architecturale", "An imagined view · architectural illustration")}</p></div>
    </div>
