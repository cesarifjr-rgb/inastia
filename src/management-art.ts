...
export function managementArt(locale: Locale): string {
  ...
  const image = "/images/inastia-management-villa";
  ...
  return `<section class="section management-art-section" id="gestion-au-quotidien"><div class="container"><div class="management-art" data-management-art>
    ...
    <figure class="management-art-figure"><div class="management-art-scene" aria-hidden="true"><picture class="management-art-house"><source type="image/avif" srcset="${image}-480.avif 480w, ${image}-960.avif 960w, ${image}-1400.avif 1400w" sizes="${sizes}"><img src="${image}-960.webp" srcset="${image}-480.webp 480w, ${image}-960.webp 960w, ${image}-1400.webp 1400w" sizes="${sizes}" width="1400" height="1120" alt="" loading="lazy" decoding="async"></picture><svg class="management-art-diagrams" viewBox="0 0 640 510" fill="none" focusable="false" aria-hidden="true">
      <g class="management-art-zone management-art-zone-listing management-art-diagram" data-management-diagram="listing" transform="translate(-3 -59) scale(.65)">
      ...
      <g class="management-art-zone management-art-zone-guests management-art-diagram" data-management-diagram="guests" transform="translate(218 -43) scale(.68)">
      ...
      <g class="management-art-zone management-art-zone-home management-art-diagram" data-management-diagram="home" transform="translate(-19 175) scale(.65)">
