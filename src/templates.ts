...
export function document(options: DocumentOptions): string {
  ...
  const schema = {
    ...
    description:
      "Conciergerie familiale de locations saisonnières sur la côte orientale de la Corse, de Ghisonaccia à Porto-Vecchio.",
  };
