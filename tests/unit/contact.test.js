...
describe("contact API (all external requests mocked)", () => {
  ...
  it.each([
    ...
    { ...valid, propertyType: "" },
    { ...valid, decisionRole: "constructor" },
    { ...valid, rentalSituation: "unknown" },
    { ...valid, startTimeline: "__proto__" },
    { ...valid, propertyArea: "a".repeat(101) },
    { ...valid, listingUrl: "javascript:alert(1)" },
    { ...valid, listingUrl: "file:///tmp/listing" },
    { ...valid, listingUrl: "not a URL" },
    { ...valid, listingUrl: "https://example.com/" + "a".repeat(500) },
    { ...valid, phone: "x" },
    { ...valid, phone: "123456" },
